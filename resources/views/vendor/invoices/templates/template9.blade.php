    ...
    <table width="796px" id="invoice-table">
        <tr>
            <td class="invoice-title">
                <p><span>Invoice #{{ $invoice->getSerialNumber() }}</span></p>
                <p><span class="invoice-for">Invoice For {{ $invoice->buyer->name }}</span></p>
            </td>
            <td id="total-due">
                <div>
                    <p><span>Total Due (Static)</span></p>
                    <p><span class="invoice-for">5000</span></p>
                </div>
            </td>
        </tr>
    </table>
