<div class="row single-post-container">
    <div class="col-md-6 col-sm-12">
        ...
        <div class="bottom-read-more-btn">
            <br>
            <hr class="mb-0">
            <a href="{{route('blogDetails',$blog->slug)}}" class="my-3 post-details-link post-readmore-btn"
            >{{__('common.Read more')}}</a>
        </div>
    </div>
    <div class="col-md-6 col-sm-12 px-0 py-sm-2 py-md-0 post-image-container">
        <a href="{{route('blogDetails',$blog->slug)}}">
